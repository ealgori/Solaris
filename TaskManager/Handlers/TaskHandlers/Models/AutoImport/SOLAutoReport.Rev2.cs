...
//using System.IO;
//using RedemptionInreract.Rev2;

//namespace TaskManager.Handlers.TaskHandlers.Models.AutoImport
//{
//    public class SOLAutoReportRev2 : ATaskHandler
//    {
//        public SOLAutoReportRev2(TaskParameters taskParameters) : base(taskParameters) { }
//        public override bool Handle()
//        {
//            var ri = new RI();
//            var mb = ri.GetMailBoxFor("technical.box.for.solaris@ericsson.com");
//            //redemtion = new RedemptionMailProcessor("SOLARIS");
//            var mails = mb.GetMails(new List<string>() { "AutoReporb" });
...
//                var subcs = TaskParameters.Context.ShContacts.Where(c => c.EMailAddress.Contains(mail.Sender.SMTPAddress)).ToList();
//                if ((subcs.Count() == 0)&& mail.Sender.SMTPAddress!="aleksey.gorin@ericsson.com")
//                {
//                    reasonMessage = "You not authorized for this request. Please contact aleksey.gorin@ericsson.com";
//                    var contacts = mail.Sender.SMTPAddress.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries).ToList();
//                    TaskParameters.EmailHandlerParams.EmailParams.Add(new EmailParams(contacts, reportName, TaskParameters.DbTask.ArchiveFolder) { DataTables = workBooksDict, HtmlBody = reasonMessage , AllowWithoutAttachments=true});
//                    mb.MoveMail(mail,@"Inbox\Incorrect");
//                    continue;
//                }
//                else
//                {
...
//                                            TaskParameters.EmailHandlerParams.EmailParams.Add(new EmailParams(new List<string> { mail.Sender.SMTPAddress }, reportName, TaskParameters.DbTask.ArchiveFolder) { HtmlBody = reasonMessage, AllowWithoutAttachments = true });
//                                            break;
//                                        }
...
//                                            TaskParameters.EmailHandlerParams.EmailParams.Add(new EmailParams(new List<string> { mail.Sender.SMTPAddress }, reportName, TaskParameters.DbTask.ArchiveFolder) { HtmlBody = reasonMessage, FilePaths = new List<string>() { reportPath } });
//                                        }
//                                        else
//                                        {
...
//                                                new EmailParams(
//                                                    new List<string> { mail.Sender.SMTPAddress }
//                                                    , reportName
//                                                    , TaskParameters.DbTask.ArchiveFolder)
//                                                    {
//                                                        HtmlBody = message
...
//                                    catch (Exception exc)
//                                    {
//                                        TaskParameters.EmailHandlerParams.EmailParams.Add(new EmailParams(new List<string> { mail.Sender.SMTPAddress }, reportName, TaskParameters.DbTask.ArchiveFolder) { HtmlBody = "Sorry, there is an error. Please contact aleksey.gorin@ericsson.com", AllowWithoutAttachments = true });
...
//                    TaskParameters.EmailHandlerParams.EmailParams.Add(new EmailParams(new List<string> { mail.Sender.SMTPAddress }, reportName, TaskParameters.DbTask.ArchiveFolder) { DataTables = workBooksDict, HtmlBody = reasonMessage });

//                mb.MoveMail(mail,@"Inbox\Produced");
//            }
//            return true;
//        }
